...
<section class="card no-print">
    <div class="card-header">
        <div>
            <h2>Estadísticas / Acciones por mes</h2>
            <p>Equivalente base a EST.ACC. del DLL: desglose mensual por tipo de acción.</p>
        </div>
        <div class="toolbar">
...
<section class="card">
    <div class="card-header">
        <div>
            <h2>Estadísticas de acciones por mes</h2>
            <p>Resume acciones de personal por año, mes y tipo de acción.</p>
        </div>
    ...
    <form method="get" action="<?= e(url('/reportes/estadisticas-acciones')) ?>" class="filters no-print">
        ...
        <div class="actions">
            ...
            <a class="button-secondary" href="<?= e(url('/reportes/estadisticas-acciones')) ?>">Limpiar</a>
        </div>
    </form>
</section>
